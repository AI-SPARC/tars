...
| QoS 0 for order/instantActions/state/factsheet/zoneSet/responses/visualization | PDF §4.1 | Partial | Order publisher and wildcard inbound subscription | Dispatch/inbound unit tests; remaining publishers pending |
